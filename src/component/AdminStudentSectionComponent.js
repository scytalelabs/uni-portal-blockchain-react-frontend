           ...
           <div className='bg3'>
                ...
                <Container fluid={true}>
                    <Row>
                        ...
                        <Col md={{ offset:1 }}>
                        <br></br><br></br>
                            <div className='Services1'style={{marginBottom:'36px'}}>
                                <LocalForm onSubmit={(values)=>this.handleSearch(values)}>
                                <br></br><br></br>
                                    <Row className='form-group'>            
                                        <Col md={{offset:1}}>
                                        <   Control.text model=".search" id="search" name="search" value={search} placeholder="Enter Student ID here to Change Section" className="form-control" onChange={this.changeHandler} style={{borderRadius: '35px',paddingRight:'250px'}}/>  
                                        </Col>
                                        <Col md={{ offset:1 }}>
                                            <Link to='/Admin/StudentSection/setSection'>
                                    ...
                                    <Row >
                                        <Col md={{offset:2}}>
                                            <br></br><br></br>
                                            <div className='EmptyBox'style={{marginBottom:'36px'}}>
                                                No Result
                                            </div>
                                        </Col>
                                    </Row>
