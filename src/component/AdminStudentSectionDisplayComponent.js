...
function deleteStudentSection(data){
    ...
    // admin / {admin_Id} /assign_section/students
    console.log("admin/1/assign_section/students",RequestBody)
    axios.delete(baseUrl+"admin/1/assign_section/students",RequestBody)
    .then(response=>{
