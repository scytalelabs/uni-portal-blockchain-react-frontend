...
class DeanVerifyGradeBySection extends Component{
      ...
      Verify(state){
        const token=localStorage.getItem('bearer_token');
          ...
          axios.get(baseUrl+'dean/semesters/courses/sections/with_grades')
          .then( res => {
            //   console.log("courses:",res);
              if(res.data.status==true)
              {
                    axios.defaults.headers.common['Authorization']=token;
                    console.log('dean/'+state.semester+'/'+state.course+'/'+state.section+'/verify_grades/specific_section');
                    
                    axios.get(baseUrl+'dean/'+state.semester+'/'+state.course+'/'+state.section+'/verify_grades/specific_section')
                    .then( res => {
    ...
    export default connect(mapStatetoProps,mapDispatchtoProps)(DeanVerifyGradeBySection);