...
class AdminTeacherSearch extends Component{
                                ...
                                <Row >
                                    <Col md={{offset:2}}>
                                        ...
                                        <br></br>
                                            <Row>
                                                <Col>Name: Zaid</Col>
                                                <Col>Qualification: BSCS</Col>
                                            </Row>
                                            <br></br>
                                            <Row>
                                                <Col>Father Name: Munir</Col>
                                            ...
                                            <br></br>
                                            <Row>
                                                <Col>Address : house#45,C block ,Sky Lake, Lahore Pakistan</Col>
                                                <Col>Email : zaid.munir@ucp.edu.pk</Col>
                                            </Row>
                                        </div>
                                    </Col>
                                </Row>
    ...
    export default AdminTeacherSearch;