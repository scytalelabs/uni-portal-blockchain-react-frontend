    ...
    return(
        <div className='container' style={{color:'white',fontFamily:'"Times New Roman", Times, serif'}}>
            ...
            <Link to='/Admin/TeacherSection'>
                <Row style={{color:'white',backgroundColor:'#3C315F',border:'1px solid #707070'}}>
                    <Col  md={{offset:1}}  >TEACHER </Col><span>&#x276F;</span>
                </Row>
            </Link>
...
class AdminAddNewTeacherSection extends Component{   
      constructor(props){
        super(props);
        this.state={
            id:null,
     ...
     render(){
        ...
        const  renderteacher = teachers.map((teacher) => {
            return (
                ...
                <option value={teacher.reg_no}>{teacher.reg_no}</option>
            );
        })
               ...
               <AdminNavbarComponent/>
                <Container fluid={true}>
                    <Row>
                        ...
                        <Col md={{ offset:1 }}>
                        <br></br><br></br>
                            <div className='Services1'style={{paddingBottom:'48px',paddingTop:'48px',color:'black'}}>
                                <LocalForm >
                                <br></br>      
                                    <Row className='form-group'>           
                                        <Col md={{offset:1}}>
                                            <div className='EditBox'style={{marginBottom:'11px'}}>
                                                <h3>Add Teacher Section</h3>
                                                <br></br>
                                                <Row>
                                                    <Col>
                                                        Registration No:
                                    ...
                                    <Row>
                                        ...
                                        <Col md={{offset:1}}>
                                            <Button  onClick={()=>addTeacherSection(this.state)} type="submit" style={{backgroundColor:'#3C315F',borderRadius: '35px',paddingLeft:'30px',paddingRight:'30px'}}>
                                                Add
                                            </Button>
                                        </Col>
                                    </Row>
    ...
    export default AdminAddNewTeacherSection;