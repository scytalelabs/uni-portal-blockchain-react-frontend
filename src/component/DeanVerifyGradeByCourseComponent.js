...
import DeanVerifyGrade from './DeanVerifyGradeComponent';
...
class DeanVerifyGradeByCourse extends Component{
      ...
      Verify(state){
        const token=localStorage.getItem('bearer_token');
          ...
          console.log('dean/'+state.semester+'/'+state.course+'/'+state.section+'/with_grades');
          axios.get(baseUrl+'dean/'+state.semester+'/'+state.course+'/has_approved_grades')
          .then( res => {
              console.log("courses:",res);
              if(res.data.status==true)
              {
                    axios.defaults.headers.common['Authorization']=token;
                    console.log('dean/'+state.semester+'/'+state.course+'/'+state.section+'/verify_grades/specific_course');
                    
                    axios.get(baseUrl+'dean/'+state.semester+'/'+state.course+'/verify_grades/specific_course')
                    .then( res => {
                        console.log("veerify:",res);
                        this.setState({
                            verify:res.data,
                            verifyflag:true,
                        })
     ...
     render(){
        ...
        {
               return <DeanVerifyGrade verify={this.state.verify} state={this.state}></DeanVerifyGrade>
        }
   }
    ...
    export default connect(mapStatetoProps,mapDispatchtoProps)(DeanVerifyGradeByCourse);